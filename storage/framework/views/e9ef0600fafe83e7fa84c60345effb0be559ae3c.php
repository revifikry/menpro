								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<select class="error form-control" v-model="idKelas">
											...
											<option value="<?php echo e($kel->id); ?>"><?php echo e($kel->jurusan->nama); ?> [<?php echo e($kel->kelas); ?>]</option>
								...
								<table class="table " style="font-size:16px;">
									...
									<tr>
										...
										<td v-if="Boolean(keldt.proposal)" >
											<img v-if="keldt.proposal.banner != null" :src="'<?php echo e(asset("/")); ?>'+keldt.proposal.banner" style="width:300px;">
									...
									<table class="table table-bordered" style="font-size:16px;">
										...
										<tbody v-if="keldt.history.length != 0">
											<tr v-for="(item,index) in keldt.history">
												<td>{{ index+1 }}</td>
												<td><a :href="'<?php echo e(asset("/")); ?>'+item.file_proposal" download="" class="btn btn-primary"><i class="fa fa-download"></i>  Download File </a></td>
...
var app = new Vue({
	...
	data: {
		...
		stand : '',
		errors: {},
		idKelas : '<?php echo e($kelas->isEmpty() ? '' : $kelas[0]->id); ?>',
		modal1 : false,
		tableLoading : false
	},
	methods: {
		...
		viewModal : async function(id){
			await axios.get('<?php echo e(url("getKelDetail")); ?>/'+id)
			.then(function (response) {
				let { data } = response
		...
		createDataTable : function(){
			$(document).ready(function(){
				...
				serverSide: true,
				ajax: {
						url : '<?php echo e(url("getTaughClass")); ?>/'+app.idKelas,
						type: "GET",
						dataType: "JSON",
						complete : function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Installer\Xampp\xampp\htdocs\menpro\resources\views/dataKelompok.blade.php ENDPATH**/ ?>