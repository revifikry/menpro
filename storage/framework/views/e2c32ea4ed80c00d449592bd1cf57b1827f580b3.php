                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-header">
                                <center>
                                    <h4><a href="<?php echo e(url("/kegiatan/".$g->id)); ?>"><?php echo e($g->judul); ?></a></h4>
                                </center>
                            </div>
...
<?php echo $__env->make('layouts.landing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\IF\Semester 8\Projekan Menpro\menpro\resources\views/lpKegiatan.blade.php ENDPATH**/ ?>