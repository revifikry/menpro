	...
	<section class="content">
		...
		<div class="box">
			<div class="box-body">
				<div class="row">
					<div class="col-md-12">
						<button class="btn btn-success" @click="modalOpen('add')"><i class="fa fa-plus"></i> Tambah User </button>
							<h3>List User  : </h3>
				...
				<div class="modal fade in" id="modal-default">
					<div class="modal-dialog">
						...
						<div class="modal-header">
							...
							<h4 v-if="mdTr == 'add'" class="modal-title">Tambah User</h4>
							<h4 v-if="mdTr == 'edit'" class="modal-title">Edit User</h4>
						</div>
...
var app = new Vue({
	...
	methods: {
		...
		editHandler : function() {
			axios.post('<?php echo e(url("editUser")); ?>',{
				id : this.dtId,
				nama : this.nama,
				nid : this.nid,
		...
		saveHandler : function (){
			...
			axios.post('<?php echo e(url("addUser")); ?>',{
				nama : this.nama,
				nid : this.nid,
				username : this.username,
				password : this.password,
		...
		deleteHandler : async function (id) {
			...
			.then(async (confirmed) => {
				if (confirmed) {
					await $.ajax({
						url : "<?php echo e(url('deleteDosen')); ?>",
						method : "POST",
						dataType : "JSON",
						data : {"id" : id},
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Installer\Xampp\xampp\htdocs\menpro\resources\views/setUser.blade.php ENDPATH**/ ?>