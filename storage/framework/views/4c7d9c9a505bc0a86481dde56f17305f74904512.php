        ...
        <div class="col-lg-12">
          ...
          <div class="row" style="padding-top:50px;">
                ...
                <div class="col-md-6" style="color:#222;margin-bottom:30px; ">
                  <img class="" src="<?php echo e(asset("$p2->banner")); ?>" alt="" style="width:200px;height:300px; float:left;margin-right:20px;cursor:pointer" onclick="window.location = '<?php echo e(url("proposalview/$p2->id")); ?>'">
                  <div class="dates" style="position: absolute;top:0 ; left :15px;background:#111;color:#f9f9f9;padding:5px 15px;text-align:center;font-size:16px;">
                    <span><?php echo e(explode(" ",$p2->historyLatest()->first()->upl_date)[0]); ?></span>
                    <br><span><?php echo e(explode(" ",$p2->historyLatest()->first()->upl_date)[1]); ?></span>
                  </div>
                  <div class="media-body">
                    ...
                    <table style="float:right;width:58%">
                      ...
                      <tr>
                        ...
                        <?php endif; ?>
                          <b> <br>Deskripsi:</b><br>
                          <?php echo $p2->deskripsi; ?>

                        <br>
                        <a style="text-decoration: underline;cursor:pointer" onclick="window.location = '<?php echo e(url("proposalview/$p2->id")); ?>'">[Lihat detail]</a>
                        <?php if(Auth::check() && Auth::user()->role != 4): ?>
                        <a  href="<?php echo e(url($p2->historyLatest()->first()->file_proposal)); ?>" download class="btn btn-info" ><i class="fa fa-download" style="color:#f9f9f9"></i>  Download Proposal </a>
                        <?php endif; ?>
                      </tr>
                    </table>
...
<?php echo $__env->make('layouts.landing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\menpro\resources\views/lpProp.blade.php ENDPATH**/ ?>