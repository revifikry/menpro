...
var app = new Vue({
	...
	methods: {
		...
		editHandler : function() {
			axios.post('<?php echo e(url("editDosen")); ?>',{
				id : this.dtId,
				nama : this.nama,
				nid : this.nid,
		...
		saveHandler : function (){
			...
			axios.post('<?php echo e(url("addDosen")); ?>',{
				nama : this.nama,
				nid : this.nid,
				username : this.username,
				password : this.password,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\IF\Semester 8\Projekan Menpro\menpro\resources\views/setDosen.blade.php ENDPATH**/ ?>