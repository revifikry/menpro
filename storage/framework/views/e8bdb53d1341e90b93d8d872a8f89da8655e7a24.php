...
var app = new Vue({
	...
	methods: {
		...
		editHandler : function() {
			axios.post('<?php echo e(url("editTAjaran")); ?>',{
				id : this.dtId,
			})
		...
		saveHandler : function (){
			...
			axios.post('<?php echo e(url("addTAjaran")); ?>',{
				tahun : this.tahun,
		...
		deleteHandler : async function (id) {
			...
			.then(async (confirmed) => {
				if (confirmed) {
					await $.ajax({
						url : "<?php echo e(url('deleteTAjaran')); ?>",
						method : "POST",
						dataType : "JSON",
						data : {"id" : id},
		...
		createDataTable : function(){
			$(document).ready(function(){
				...
				serverSide: true,
				ajax: {
						url : '<?php echo e(url("tajaranData")); ?>',
						type: "GET",
						dataType: "JSON",
						complete : function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Installer\Xampp\xampp\htdocs\menpro\resources\views/tahunajaran.blade.php ENDPATH**/ ?>