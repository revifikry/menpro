    ...
    <nav class="navbar navbar-light" style=" background-color: #fc8e22;">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">
          ...
          <style type="text/css"> i {color: white; font-size: 10px; text-size-adjust: 10px;}</style>
        ...
        <div class="col-lg-4 col-sm-12 header-social">
          <style type="text/css"> i {color: white; font-size: 17px; text-size-adjust: 15px;}</style>
    ...
    <div class="container">
      ...
      <div class="row footer-bottom d-flex justify-content-between">
        ...
        <p class="col-lg-8 col-sm-12 footer-text">Copyright &copy;<script>
          ...
          </script> All rights reserved. Created by M Bachtiar Amin, Nadiati Salsabilla | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a></p>
        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
...
</html><?php /**PATH C:\Installer\Xampp\xampp\htdocs\menpro\resources\views/layouts/landing.blade.php ENDPATH**/ ?>