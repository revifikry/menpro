			...
			<div class="box-body">
				<div class="row">
					<div class="col-md-12">
						...
						<button class="btn btn-success" @click="modalOpen('add')"><i class="fa fa-plus"></i> Buat Dokumentasi Kegiatan</button>
				...
				<div class="modal fade in" id="modal-default">
					<div class="modal-dialog">
						...
						<div class="modal-header">
							...
							<h4 class="modal-title">Buat Dokumentasi Kegiatan</h4>
						</div>
				...
				<div class="modal fade in" id="modal-view">
					<div class="modal-dialog modal-lg">
						...
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">×</span></button>
							<h4 class="modal-title">Preview Kegiatan</h4>
						</div>
						<div class="modal-body">
...
var app = new Vue({
	...
	methods: {
		...
		editHandler : function() {
			...
			axios.post( '<?php echo e(url('/editKegiatan')); ?>',
						formData,
						{
							headers: {
		...
		saveHandler : function (){
			...
			axios.post( '<?php echo e(url('/addKegiatan')); ?>', 
						formData,
						{
							headers: {
								'Content-Type': 'multipart/form-data'
		...
		deleteHandler : async function (id) {
			...
			.then(async (confirmed) => {
				if (confirmed) {
					await $.ajax({
						url : "<?php echo e(url('deleteKegiatan')); ?>",
						method : "POST",
						dataType : "JSON",
						data : {"id" : id},
		...
		createDataTable : function(){
			$(document).ready(function(){
				...
				serverSide: true,
				ajax: {
						url : '<?php echo e(url("getKegiatan")); ?>',
						type: "GET",
						dataType: "JSON",
						complete : function(d){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Installer\Xampp\xampp\htdocs\menpro\resources\views/createKegiatan.blade.php ENDPATH**/ ?>