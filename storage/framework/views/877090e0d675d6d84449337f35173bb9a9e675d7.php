						...
						<div class="modal-body">
							<div :class="Boolean(errors.tahun)? 'form-group has-error' : 'form-group'">
								...
								<select class="error form-control" v-model="tahun">
									<option value="<?php echo e($ta->id); ?>"><?php echo e($ta->tahun); ?> - <?php echo e($ta->semester_act); ?></option>
								</select>
...
var app = new Vue({
	...
	methods: {
		...
		editHandler : function() {
			axios.post('<?php echo e(url("editKelas")); ?>',{
				id : this.dtId,
				tahun : this.tahun,
		...
		saveHandler : function (){
			...
			axios.post('<?php echo e(url("addKelas")); ?>',{
				tahun : this.tahun,
				jurusan : this.jurusan,
				kelas : this.kelas,
				dosen : this.dosen
		...
		getDataJurusan : function(){
			axios.get('<?php echo e(url("getJurusanActive")); ?>')
			.then(function (response) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\menpro\resources\views/kelas.blade.php ENDPATH**/ ?>