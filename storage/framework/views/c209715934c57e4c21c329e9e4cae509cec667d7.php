...
var app = new Vue({
	...
	data: {
		...
		email : '',
		role : '3',
		deskripsi : '<?php echo str_replace("'","&apos;",$deskripsi ); ?>',
		password : '',
		errors: {},
		dtId : '',
		mdTr : '',
	...
	methods: {
		...
		editHandler2 : function() {
			...
			axios.post('<?php echo e(url("editKoorText")); ?>',{
		...
		editHandler : function() {
			...
			axios.post('<?php echo e(url("editKoor")); ?>',
				formData,
				{
					headers: {
		...
		saveHandler : function (){
			...
			formData.append('file2', this.file2);
			formData.append('name', this.nama);
			axios.post('<?php echo e(url("addKoor")); ?>',
				formData,
				{
					headers: {
						'Content-Type': 'multipart/form-data'
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\IF\Semester 8\Projekan Menpro\menpro\resources\views/setKoor.blade.php ENDPATH**/ ?>