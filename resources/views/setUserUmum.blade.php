	...
	<section class="content">
		...
		<div class="box">
			<div class="box-body">
				<div class="row">
					<div class="col-md-12">
						<button class="btn btn-success" @click="modalOpen('add')"><i class="fa fa-plus"></i> Tambah User Umum </button>
							<h3>List User Umum : </h3>
				...
				<div class="modal fade in" id="modal-default">
					<div class="modal-dialog">
						...
						<div class="modal-header">
							...
							<h4 v-if="mdTr == 'add'" class="modal-title">Tambah User Umum</h4>
							<h4 v-if="mdTr == 'edit'" class="modal-title">Edit User Umum</h4>
						</div>
