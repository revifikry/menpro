<header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b><img src="{{ asset("images/wiralogobaru1.png")}}" style="width:100px;"></b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="{{ asset("images/wiralogobaru1.png")}}" style="width:100px;"><b></b></span>
    </a>
